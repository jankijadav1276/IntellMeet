...
const [loadingMeeting, setLoadingMeeting] = useState(!!meetingCode)
...
useEffect(() => {
  ...
  const loadMeeting = async () => {
    try {
      const meeting =
        await meetingService.getMeetingByCode(meetingCode)
...
}, [socket, meetingId, user?._id, navigate])


  // ================= JOIN REQUEST =================
const handleJoinRequest = () => {
  if (!socket || !meetingId || !user?._id) return
